...
public class ProdutoDAO {
	 ...
	 * 
	 * @param dataSource Um objeto de conexão da classe DataSource
	 */
		...
		try {
			...
			System.out.println("Deseja mudar o nome? (S/N)");
				...
				case "S":
						...
						System.out.println("Qual a nova categoria? 1- Proteínas | 2- Laticinios | 3- Limpeza | 4- Carnes");
				...
				case "S":
						...
						System.out.println("Quantos itens hà no estoque?");
						Integer novoValor = Integer.valueOf(sc.nextLine());
