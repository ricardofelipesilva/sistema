/**
		 * @author Ricardo
		 * Os métodos presente na Classe Main são necessários apenas para a execução do menu e passagem de parâmentro. 
		 * Os métodos implementados não retornam e também não recebem nenhum valor/ parâmetro.
...
public class Main {
	...
	/**
	 * Método para mostrar apenas as proteínas.
	 */
	...
	/**
	 * Método para mostrar apenas os Laticínios.
	 */
	...
	/**
	 * Método para mostrar apenas os produtos de limpeza.
	 */
	...
	/**
	 * Método para mostrar apenas as carnes.
	 */
	...
	/**
	 * Método para mandar pressionar enter para prosseguir.
	 */
	...
	/**
	 * Método para simular uma limpeza do console;
	 */
